...
- ??????????????
  - `release/desktop/mac-arm64` ???? `2081646526` ?????? `SQL-Copliot-0.1.0-mac-arm64.zip` ? `833721825` ???
  - `release/desktop/win-x64` ???? `2292471401` ?????? `SQL-Copliot-0.1.0-win-x64.exe` ? `793658767` ???
